    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted" >Selamat Datang Di Hotel Rema</h3>
                ...
                <table class="table table-bordered table-hover">
                    <tbody>
                        <tr>
                            ...
                            <td>:</td>
                            <td class="text-start"><input class="form-control" type="text" name="email" value="<?= $user['email'] ?>"></td>
                        </tr>
                        <tr>
